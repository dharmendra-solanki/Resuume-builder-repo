      ...
      <div className="flex items-center gap-4">
        ...
        <label className="cursor-pointer">
          {data.image ? (
            ...
            <div className="flex items-center gap-2 text-slate-600 hover:text-slate-700">
        ...
        {data.image && (
          <div className="flex flex-col text-sm gap-1">
            ...
            <label className="relative inline-flex items-center cursor-pointer gap-2">
              ...
              <div className="relative w-9 h-5 bg-slate-300 rounded-full peer-checked:bg-green-600 transition-colors">
