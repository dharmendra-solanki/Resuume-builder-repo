...
const ExperienceForm = ({ data, onChange }) => {
  ...
  const generateDescription = async( index)=>{
    ...
    const prompt = `You are an expert resume writer.
        ...
        Rewrite and enhance the following job Description:
        - Make it more impactful and professional
        - Improve clarity and flow
        - Add strong action verbs
        - Keep it concise (3-4 sentences)
        - DO NOT add headings, explanations, markdown, or symbols
        - Return ONLY the enhanced summary text

        job description:
        ${experience.description} for the position of ${experience.position} at ${experience.company}`
            ...
            >
              ...
              <div className="space-y-2 ">
                <div className="flex items-center justify-between">
                  ...
                  <button onClick={()=> generateDescription(index)} disabled={generatingIndex === index || (!experience.position.trim() || !experience.company.trim())}
                ...
                <textarea
                  ...
                  placeholder="Describe you key responsibilities and achievements..."
                ></textarea>
              </div>
            </div>
          ))}
