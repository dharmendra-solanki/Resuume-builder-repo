...
const ResumeBuilder = () => {
  // ✅ Correct way to get route param
  ...
  const changeResumeVisibility = async (params) => {
    try {
      ...
      console.log('Error savin resume:', error)
    }
  };
          ...
          <div className="relative lg:col-span-5 rounded-lg overflow-hidden">
            <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6 pt-1">
              ...
              <div className="flex justify-between items-center mb-6 border-b border-gray-300 py-1">
                <div className="flex justify-between items-center border-gray-300 py-1 gap-2">
                  <TemplateSelector
            ...
            <div className="relative w-full ">
              <div className="absolute bottom-3 left-0 right-0 flex items-center justify-end gap-2">
                ...
                <button
                  ...
                  className="flex items-center gap-2 px-6 py-2 text-xs bg-gradient-to-br 
